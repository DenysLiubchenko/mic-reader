...
public class ConsumerProductFactIT extends AbstractIT{
    @Autowired
    ...
    private final String FACT_TOPIC = "outbox.event.product-fact";
    ...
    public void testConsume() {
        ...
        final ProducerRecord<String, Object> record =
                new ProducerRecord<>(FACT_TOPIC, null, id.toString(), productFactEvent);
